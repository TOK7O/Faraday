      ...
      <div className="product-grid-view">
        {products.map((p) => (
          <div className="product-card glass-card fade-in-up" key={p.id}>
            <div
              className={`product-icon-box ${p.isHazardous ? "hazardous" : ""}`}
            >
              {p.isHazardous ? (
            ...
            <div className="product-actions">
              <button
                ...
                title={invT.catalog.tooltips.edit}
              >
                <Pencil size={18} />
              </button>
              <button
                ...
                title={invT.catalog.tooltips.delete}
              >
                <Trash2 size={18} />
              </button>
            </div>
            ...
            {p.isHazardous && (
              <div
                ...
                title={invT.catalog.tooltips.hazardous}
              >
