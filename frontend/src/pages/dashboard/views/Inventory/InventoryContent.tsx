                                ...
                                <Dialog.Portal>
                                    ...
                                    <Dialog.Content className="dialog-content-ht">
                                        ...
                                        <div className="modal-header">
                                            <Dialog.Title>
                                                <h2>{editingRack ? invT.editRack : invT.newRack}</h2>
                                            </Dialog.Title>
                                        ...
                                        >
                                            <div className="input-row">
                                                <div className="input-group">
                                                    ...
                                                    <input name="id" defaultValue={editingRack?.id} placeholder={invT.idPlaceholder} required />
                                                </div>
                                                <div className="input-group">
                                                    <label>{invT.sectionDescription}</label>
                                                    <input name="comment" defaultValue={editingRack?.comment} placeholder={invT.sectionPlaceholder} />
                                                </div>
                                            </div>

                                            <div className="input-row">
                                                <div className="input-group">
                                                    <label>{invT.rowsM}</label>
                                                    <input type="number" name="m" defaultValue={editingRack?.m} required />
                                                </div>
                                                <div className="input-group">
                                                    <label>{invT.colsN}</label>
                                                    <input type="number" name="n" defaultValue={editingRack?.n} required />
                                                </div>
                                                <div className="input-group">
                                                    <label>{invT.maxWeightKg}</label>
                                            ...
                                            <div className="input-row">
                                                ...
                                                <div className="input-group">
                                                    <label>{invT.slotDimensionsMm}</label>
