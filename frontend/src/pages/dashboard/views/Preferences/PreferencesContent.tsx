        ...
        <div className="pref-section full-width">
          ...
          <div className="security-panel">
            <div className="panel-header">
              ...
              <div
                className={`status-badge ${is2faEnabled ? "active" : "inactive"}`}
              >
                {is2faEnabled ? (
                  <Check size={14} />
                ) : (
                ...
                <span>
                  {is2faEnabled
                    ? prefT.security.twoFactor.status.enabled
                    : prefT.security.twoFactor.status.disabled}
                </span>
              </div>
            </div>
            ...
            {!is2faEnabled && !setupData && (
              <div>
                ...
                >
                  {loading2fa
                    ? prefT.security.twoFactor.actions.loading
                    : prefT.security.twoFactor.actions.setup}
                </button>
              </div>
            )}
                ...
                <div className="qr-container">
                  ...
                  <div className="instructions">
                    ...
                    <p style={{ marginTop: "10px" }}>
                      {prefT.security.twoFactor.setup.verifyStep2}
                    </p>
                    <div className="verify-group">
                      ...
                      >
                        {loading2fa
                          ? prefT.security.twoFactor.actions.verifying
                          : prefT.security.twoFactor.actions.enable}
                      </button>
                    </div>
                  </div>
                </div>
