...
import { History, Search, RefreshCw, Box, User, MapPin, ArrowRight, ArrowLeft, RefreshCcw, Loader2 } from "lucide-react";
...
const OperationsHistory = () => {
    ...
    const getOpConfig = (type: string) => {
        switch (type) {
            ...
            case "Outbound": return { color: "#ef4444", icon: <ArrowLeft size={14} />, label: opT.types.dispatched };
            case "Movement": return { color: "#f59e0b", icon: <RefreshCcw size={14} />, label: opT.types.moved };
        ...
        <div className="operations-view-container">
            ...
            <div className="glass-table-wrapper">
                <table className="ht-table">
                    ...
                    <tbody>
                        {loading ? (
                            <tr><td colSpan={5} style={{ textAlign: 'center', padding: '3rem', opacity: 0.5 }}>
                            ...
                            <tr><td colSpan={5} style={{ textAlign: 'center', padding: '3rem', opacity: 0.5 }}>{opT.empty}</td></tr>
                        ) : (
