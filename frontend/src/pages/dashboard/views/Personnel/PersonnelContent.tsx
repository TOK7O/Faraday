    ...
    <div className="personnel-view-container">
      <header className="content-header">
        <div className="header-brand">
          ...
          <h1>{tPers.title}</h1>
          <p className="lead-text">{tPers.description}</p>
        </div>
      </header>
          ...
          <table className="ht-table">
            <thead>
              <tr>
                ...
                {isAdmin && (
                  <th className="text-right">{tPers.table.action}</th>
                )}
              </tr>
            </thead>
            <tbody>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="dialog-content-ht">
            <div className="modal-header">
              <h2>
                <Edit size={24} className="icon-accent" />{" "}
      ...
      <Dialog.Root open={isResetPassOpen} onOpenChange={setIsResetPassOpen}>
        <Dialog.Portal>
          ...
          <Dialog.Content className="dialog-content-ht">
            <div className="modal-header">
              <h2>
                <Key size={24} className="icon-accent" />{" "}
                {tModals.resetPassword.title}
              </h2>
              <button
                className="btn-close"
            ...
            <Form.Root className="ht-form" onSubmit={handleResetPassword}>
              <p style={{ color: "var(--text-muted)", fontSize: "0.9rem" }}>
                {tModals.resetPassword.description}{" "}
