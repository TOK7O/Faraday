...
namespace Faraday.API.Migrations
{
    ...
    [Migration("20260209102917_InitMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Faraday.API.Models.OperationLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Faraday.API.Models.ProductDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Faraday.API.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Faraday.API.Models.Rack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Faraday.API.Models.RackSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Faraday.API.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Faraday.API.Models.BackupLog", b =>
                {
                    b.HasOne("Faraday.API.Models.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Faraday.API.Models.InventoryItem", b =>
                {
                    b.HasOne("Faraday.API.Models.ProductDefinition", "Product")
                        .WithMany()
                        .HasForeignKey("ProductDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Faraday.API.Models.RackSlot", "Slot")
                        .WithOne("CurrentItem")
                        .HasForeignKey("Faraday.API.Models.InventoryItem", "RackSlotId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Faraday.API.Models.User", "ReceivedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Faraday.API.Models.OperationLog", b =>
                {
                    b.HasOne("Faraday.API.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Faraday.API.Models.ProductImage", b =>
                {
                    ...
                    b.HasOne("Faraday.API.Models.User", "UploadedByUser")
                        .WithMany()
