...
public class BackupService : IBackupService
{
    ...
    public async Task<string> CreateFullBackupAsync()
    {
        ...
        _logger.LogDebug($"pg_dump process started for backup: {fileName}");
    ...
    private static (string Host, string User, string Password, string Db) ParseConnectionString(string connString)
    {
