...
public class RackService(FaradayDbContext context, ILogger<RackService> logger) : IRackService
{
    ...
    public async Task<RackDto> UpdateRackAsync(int id, RackUpdateDto dto)
    {
        ...
        if (storedItems.Count != 0)
        {
            ...
            foreach (var product in storedItems.Where(product => dto.MinTemperature < product.RequiredMinTemp ||
            ...
            foreach (var product in storedItems.Where(product => product.WidthMm > dto.MaxItemWidthMm ||
