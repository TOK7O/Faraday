    ...
    : IAuthService
{
    ...
    private string GenerateJwtToken(User user)
    {
        ...
        return new Microsoft.IdentityModel.JsonWebTokens.JsonWebTokenHandler().CreateToken(tokenDescriptor);
    }
    ...
    public async Task DeleteUserAsync(int targetUserId, int adminId)
    {
        ...
        if (admin is not { Role: UserRole.Administrator })
        ...
        switch (user)
        {
            ...
            case { Role: UserRole.Administrator, IsActive: true }:
            {
